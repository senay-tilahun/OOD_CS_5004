...
/**
 * Test Class for concrete methods implemented in AbstractPublication
 * <p>
...
public class AbstractPublicationTest {
  ...
  /**
   * Verify that getTitle returns the Publication's title as constructed
   */
  @Test
  ...
  /**
   * Verify that getYear returns Publication's year as constructed
   */
  @Test
  ...
  /**
   * Verify that getAuthor returns the Publication's author as constructed
   */
  @Test
  ...
  /**
   * Verify that getPrice returns the Publication's current price
   * <p>
  ...
  /**
   * Verify that sameAuthor correctly compares authors of two Publications
   */
  @Test
  ...
  /**
   * Verify that getKind returns the Publication's kind as constructed
   * <p>
   * Not a getter for a field! String computed from the name of the subClass
   */
  @Test
